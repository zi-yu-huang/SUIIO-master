...
function FM_my_card() {
  return (
    <a href="/Financial/statements/audit/detail"  style={{ borderRadius: "15px", backgroundColor: "#8EA299" }} className="col-sm-10 col-md-5 mx-4 my-2">
      <div className="p-2">
        <div className="row">
          <h3 className="col">審核財報</h3>
          <div>
